...
//+kubebuilder:rbac:groups=opensearch.eliatra.io,resources=opensearchcomponenttemplates,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=opensearch.eliatra.io,resources=opensearchcomponenttemplates/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=opensearch.eliatra.io,resources=opensearchcomponenttemplates/finalizers,verbs=update
...
func (r *OpensearchComponentTemplateReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	r.Instance = &eliatrav1.OpensearchComponentTemplate{}
...
func (r *OpensearchComponentTemplateReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&eliatrav1.OpensearchComponentTemplate{}).
		Owns(&eliatrav1.OpenSearchCluster{}). // Get notified when opensearch clusters change
		Complete(r)
}
