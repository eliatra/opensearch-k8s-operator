...
//+kubebuilder:rbac:groups=opensearch.eliatra.io,resources=opensearchtenants,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=opensearch.eliatra.io,resources=opensearchtenants/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=opensearch.eliatra.io,resources=opensearchtenants/finalizers,verbs=update
...
func (r *OpensearchTenantReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	r.Instance = &eliatrav1.OpensearchTenant{}
...
func (r *OpensearchTenantReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&eliatrav1.OpensearchTenant{}).
