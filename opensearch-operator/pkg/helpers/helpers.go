...
func FindFirstPartial(
	arr []eliatrav1.ComponentStatus,
	item eliatrav1.ComponentStatus,
	predicator func(eliatrav1.ComponentStatus, eliatrav1.ComponentStatus) (eliatrav1.ComponentStatus, bool),
) (eliatrav1.ComponentStatus, bool) {
	for i := 0; i < len(arr); i++ {
