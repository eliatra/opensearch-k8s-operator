...
func (r *UpgradeReconciler) Reconcile() (ctrl.Result, error) {
	...
	case "Pending":
		...
		err := r.client.UpdateOpenSearchClusterStatus(client.ObjectKeyFromObject(r.instance), func(instance *eliatrav1.OpenSearchCluster) {
...
func (r *UpgradeReconciler) findNextNodePoolForUpgrade() (eliatrav1.NodePool, eliatrav1.ComponentStatus) {
	// First sort node pools
	var dataNodes, dataAndMasterNodes, otherNodes []eliatrav1.NodePool
	...
	if found {
		return pool, eliatrav1.ComponentStatus{
			Component:   "Upgrader",
			Description: pool.Component,
			Status:      "Upgrading",
		}
	...
	return eliatrav1.NodePool{}, eliatrav1.ComponentStatus{
		Component: "Upgrade",
		Status:    "Finished",
	}
}

func (r *UpgradeReconciler) findInProgress(pools []eliatrav1.NodePool) (eliatrav1.NodePool, bool) {
	...
	return eliatrav1.NodePool{}, false
}

func (r *UpgradeReconciler) findNextPool(pools []eliatrav1.NodePool) (eliatrav1.NodePool, bool) {
	for _, nodePool := range pools {
		componentStatus := eliatrav1.ComponentStatus{
			Component:   "Upgrader",
			Description: nodePool.Component,
...
func (r *UpgradeReconciler) doNodePoolUpgrade(pool eliatrav1.NodePool) error {
	...
	if sts.Status.UpdatedReplicas == lo.FromPtrOr(sts.Spec.Replicas, 1) {
		...
		return r.client.UpdateOpenSearchClusterStatus(client.ObjectKeyFromObject(r.instance), func(instance *eliatrav1.OpenSearchCluster) {
...
func (r *UpgradeReconciler) setComponentConditions(conditions []string, component string) {
	...
	err := r.client.UpdateOpenSearchClusterStatus(client.ObjectKeyFromObject(r.instance), func(instance *eliatrav1.OpenSearchCluster) {
		...
		newStatus := eliatrav1.ComponentStatus{
			Component:   "Upgrader",
			Status:      "Upgrading",
			Description: component,
