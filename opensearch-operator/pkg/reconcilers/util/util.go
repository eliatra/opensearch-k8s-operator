...
func ReadOrGenerateCaCert(pki tls.PKI, k8sClient k8s.K8sClient, instance *eliatrav1.OpenSearchCluster) (tls.Cert, error) {
...
func OpensearchClusterURL(cluster *eliatrav1.OpenSearchCluster) string {
	return fmt.Sprintf(
		"https://%s.%s.svc.%s:%v",
...
) (*eliatrav1.OpenSearchCluster, error) {
...
func DataNodesCount(k8sClient k8s.K8sClient, cr *eliatrav1.OpenSearchCluster) int32 {
	count := int32(0)
...
func GetClusterHealth(k8sClient k8s.K8sClient, ctx context.Context, cluster *eliatrav1.OpenSearchCluster, lg logr.Logger) eliatrav1.OpenSearchHealth {
	...
	if err != nil {
		...
		return eliatrav1.OpenSearchUnknownHealth
	}
	...
	return eliatrav1.OpenSearchHealth(healthResponse.Status)
}

// GetAvailableOpenSearchNodes returns the sum of ready pods for all node pools
func GetAvailableOpenSearchNodes(k8sClient k8s.K8sClient, ctx context.Context, cluster *eliatrav1.OpenSearchCluster, lg logr.Logger) int32 {
