...
func (r *ClusterReconciler) reconcileNodeStatefulSet(nodePool eliatrav1.NodePool, username string) (*ctrl.Result, error) {
...
func (r *ClusterReconciler) handlePDB(nodePool *eliatrav1.NodePool) (*ctrl.Result, error) {
...
func (r *ClusterReconciler) maybeUpdateVolumes(existing *appsv1.StatefulSet, nodePool eliatrav1.NodePool) error {
