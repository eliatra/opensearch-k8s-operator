...
func NewReconcilerContext(recorder record.EventRecorder, instance *eliatrav1.OpenSearchCluster, nodepools []eliatrav1.NodePool) ReconcilerContext {
...
func UpdateComponentStatus(
	...
	if status != nil {
		return k8sClient.UpdateOpenSearchClusterStatus(client.ObjectKeyFromObject(cluster), func(instance *eliatrav1.OpenSearchCluster) {
			found := false
